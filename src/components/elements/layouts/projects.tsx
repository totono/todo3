...
//limit_dateがnullの場合は3000/01/01とし、limit_timeがnullの場合は00:00とする。
...
const byRecent = (a: Model, b: Model) => {
  ...
  const aTime = a.limit_time === null ? "00:00" : a.limit_time;
  const bTime = b.limit_time === null ? "00:00" : b.limit_time;
